/* ═══════════════════════════════════════════════════════════════════
   ...
   [가격 변경 이력] 화면마다 흩어져 있던 기록을 여기 모읍니다.
     ...
     · 260806 — ★「인생여행」 이름을 「두 분의 여정」으로 교체(대표 확정).
         값 110,000 그대로 · 상품코드 LF-A 그대로 · 코드키 gas:'life' 그대로.
         발권·주문대장 J열·오픈마켓 주소 스물넷은 한 글자도 안 건드렸습니다.
         ※ 스마트스토어 상품명 여섯(LF-A001·010·020·030·050·100)은 이 파일 밖입니다.
           대표님이 스토어에서 함께 바꾸셔야 이름이 어긋나지 않습니다.
...
(function () {
  ...
  var UNIT = {
    ...
    A: { name: '두 분의 여정 (지도+편지+기록)', price: 110000, gas: 'life' }
  };
